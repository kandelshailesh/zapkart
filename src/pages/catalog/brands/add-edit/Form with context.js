...
// import Form, {Provider as FormProvider, Consumer as FormConsumer} from 'components/Form'
  ...
  return (
    <>
      <Form
        ...
        formItems={formItems}
      />
      <Form.Provider onSubmit={submitForm} schema={brandSchema} initialValues={values}>
        <Form.Consumer>
          {({ schema, initialValues: a }) => (
            <Form initialValues={a} formItems={formItems} schema={schema} onSubmit={submitForm} />
          )}
        </Form.Consumer>
      </Form.Provider>
    </>
