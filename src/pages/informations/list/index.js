...
import { getInformations, editInformationStatus, deleteInformation } from 'services/informations'
...
class InformationsList extends React.Component {
  ...
  handleMenuClick = async e => {
    ...
    const isUpdated = await editInformationStatus(clickedId, e.key)
    if (isUpdated) {
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: record => (
          <span>
            <Link to={`${LINKS.informations}/edit/${record._id}`}>
